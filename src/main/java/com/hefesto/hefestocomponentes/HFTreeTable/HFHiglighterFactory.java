 ...
 * @author Flavio
 */
public final class HFHiglighterFactory {
    ...
    public static Highlighter createSimpleStriping(int rowsPerGroup) {
        return new UIColorHighlighter(new HighlightPredicate.RowGroupHighlightPredicate(
                rowsPerGroup));
    }
    ...
    public static Highlighter createSimpleStriping(Color stripeBackground,
            int rowsPerGroup) {
        HighlightPredicate predicate = new HighlightPredicate.RowGroupHighlightPredicate(
                rowsPerGroup);
    ...
    public static Highlighter createAlternateStriping(int rowsPerGroup) {
        HighlightPredicate predicate = new HighlightPredicate.RowGroupHighlightPredicate(rowsPerGroup);
        ColorHighlighter first = new ColorHighlighter(new HighlightPredicate.NotHighlightPredicate(predicate), Color.WHITE, null);
    ...
    public static Highlighter createAlternateStriping(Color baseBackground, Color alternateBackground, int linesPerStripe) {
        ...
        ColorHighlighter base = new ColorHighlighter(new HighlightPredicate.NotHighlightPredicate(predicate), baseBackground, null);
...
//     }
    ...
    public final static Color HEFESTO = new Color(208, 231, 255);
