 ...
 * @author Flavio
 */
public class HFLineGrafPainel extends JPanel {
    ...
    public HFLineGrafPainel() {
        initComponents();
        graf = ChartFactory.createLineChart(titulo, legenda, eyxoY, new DefaultCategoryDataset(), PlotOrientation.VERTICAL, legendas, tooltips, urls);
    ...
    public void setDataSource(List<HFGrafDataSource> dataSource) {
        ...
        graf = ChartFactory.createLineChart(titulo, legenda, eyxoY, df, PlotOrientation.VERTICAL, legendas, tooltips, urls);
    ...
    private ComponentListener resizeListner() {
        return new ComponentListener() {
            ...
            public void componentResized(ComponentEvent e) {
                HFLineGrafPainel.this.GrafPanel.setSize(HFLineGrafPainel.this.getWidth(), HFLineGrafPainel.this.getHeight());
                HFLineGrafPainel.this.revalidate();
                HFLineGrafPainel.this.repaint();
            }
