 ...
 * @author Tim Molderez
 */
public class HFCustomBalloonTip extends BalloonTip {
	 ...
	 */
	public HFCustomBalloonTip(JComponent attachedComponent, JComponent comp, Rectangle offset, BalloonTipStyle style, BalloonTip.Orientation alignment, BalloonTip.AttachLocation attachLocation, int horizontalOffset, int verticalOffset, boolean useCloseButton) {
		super(attachedComponent, comp, style, alignment, attachLocation, horizontalOffset, verticalOffset, useCloseButton);
		this.offset = offset;
		refreshLocation();
	}
	 ...
	 */
	public HFCustomBalloonTip(JComponent attachedComponent, JComponent text, Rectangle offset, BalloonTipStyle style, BalloonTipPositioner positioner, JButton useCloseButton) {
	...
	public void refreshLocation() {
		...
		try {
			...
			if (isAttachedComponentShowing() && viewport != null && viewport.isShowing()) {
