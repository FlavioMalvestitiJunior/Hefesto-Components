 ...
 * @author flavio
 */
public class HFNumberFieldBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_bigDecimalValor = 13;
    private static final int PROPERTY_bigIntValor = 14;
    private static final int PROPERTY_bigValor = 15;
    ...
    private static final int PROPERTY_editValid = 43;
    private static final int PROPERTY_enabled = 44;
    private static final int PROPERTY_focusable = 45;
    private static final int PROPERTY_focusAccelerator = 46;
    ...
    private static final int PROPERTY_focusLostBehavior = 50;
    ...
    private static final int PROPERTY_formatter = 62;
    private static final int PROPERTY_formatterFactory = 63;
    ...
    private static final int PROPERTY_intValor = 80;
    ...
    private static final int PROPERTY_margin = 89;
    private static final int PROPERTY_maximumSize = 90;
    private static final int PROPERTY_maximumSizeSet = 91;
    private static final int PROPERTY_minimumSize = 92;
    private static final int PROPERTY_minimumSizeSet = 93;
    private static final int PROPERTY_moeda = 94;
    ...
    private static final int PROPERTY_numeroCasa = 102;
    ...
    private static final int PROPERTY_preferredScrollableViewportSize = 109;
    private static final int PROPERTY_preferredSize = 110;
    private static final int PROPERTY_preferredSizeSet = 111;
    ...
    private static final int PROPERTY_scrollableTracksViewportHeight = 116;
    private static final int PROPERTY_scrollableTracksViewportWidth = 117;
    private static final int PROPERTY_scrollOffset = 118;
    private static final int PROPERTY_selectedText = 119;
    private static final int PROPERTY_selectedTextColor = 120;
    private static final int PROPERTY_selectionColor = 121;
    private static final int PROPERTY_selectionEnd = 122;
    private static final int PROPERTY_selectionStart = 123;
    private static final int PROPERTY_showing = 124;
    private static final int PROPERTY_size = 125;
    private static final int PROPERTY_text = 126;
    private static final int PROPERTY_toolkit = 127;
    private static final int PROPERTY_toolTipText = 128;
    private static final int PROPERTY_topLevelAncestor = 129;
    private static final int PROPERTY_transferHandler = 130;
    private static final int PROPERTY_treeLock = 131;
    private static final int PROPERTY_UI = 132;
    private static final int PROPERTY_UIClassID = 133;
    private static final int PROPERTY_valid = 134;
    private static final int PROPERTY_validateRoot = 135;
    private static final int PROPERTY_valor = 136;
    private static final int PROPERTY_value = 137;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_action] = new PropertyDescriptor ( "action", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getAction", "setAction" ); // NOI18N
            properties[PROPERTY_actionCommand] = new PropertyDescriptor ( "actionCommand", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, null, "setActionCommand" ); // NOI18N
            properties[PROPERTY_actionListeners] = new PropertyDescriptor ( "actionListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getActionListeners", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_actions] = new PropertyDescriptor ( "actions", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getActions", null ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_bigDecimalValor] = new PropertyDescriptor ( "bigDecimalValor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, null, "setBigDecimalValor" ); // NOI18N
            properties[PROPERTY_bigIntValor] = new PropertyDescriptor ( "bigIntValor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getBigIntValor", "setBigIntValor" ); // NOI18N
            properties[PROPERTY_bigValor] = new PropertyDescriptor ( "bigValor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getBigValor", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_caret] = new PropertyDescriptor ( "caret", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getCaret", "setCaret" ); // NOI18N
            properties[PROPERTY_caretColor] = new PropertyDescriptor ( "caretColor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getCaretColor", "setCaretColor" ); // NOI18N
            properties[PROPERTY_caretListeners] = new PropertyDescriptor ( "caretListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getCaretListeners", null ); // NOI18N
            properties[PROPERTY_caretPosition] = new PropertyDescriptor ( "caretPosition", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getCaretPosition", "setCaretPosition" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_columns] = new PropertyDescriptor ( "columns", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getColumns", "setColumns" ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_disabledTextColor] = new PropertyDescriptor ( "disabledTextColor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getDisabledTextColor", "setDisabledTextColor" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_document] = new PropertyDescriptor ( "document", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getDocument", "setDocument" ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dragEnabled] = new PropertyDescriptor ( "dragEnabled", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getDragEnabled", "setDragEnabled" ); // NOI18N
            properties[PROPERTY_dropLocation] = new PropertyDescriptor ( "dropLocation", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getDropLocation", null ); // NOI18N
            properties[PROPERTY_dropMode] = new PropertyDescriptor ( "dropMode", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getDropMode", "setDropMode" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_editable] = new PropertyDescriptor ( "editable", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isEditable", "setEditable" ); // NOI18N
            properties[PROPERTY_editValid] = new PropertyDescriptor ( "editValid", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isEditValid", null ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusAccelerator] = new PropertyDescriptor ( "focusAccelerator", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFocusAccelerator", "setFocusAccelerator" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusLostBehavior] = new PropertyDescriptor ( "focusLostBehavior", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFocusLostBehavior", "setFocusLostBehavior" ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_formatter] = new PropertyDescriptor ( "formatter", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFormatter", null ); // NOI18N
            properties[PROPERTY_formatterFactory] = new PropertyDescriptor ( "formatterFactory", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getFormatterFactory", "setFormatterFactory" ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_highlighter] = new PropertyDescriptor ( "highlighter", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getHighlighter", "setHighlighter" ); // NOI18N
            properties[PROPERTY_horizontalAlignment] = new PropertyDescriptor ( "horizontalAlignment", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getHorizontalAlignment", "setHorizontalAlignment" ); // NOI18N
            properties[PROPERTY_horizontalVisibility] = new PropertyDescriptor ( "horizontalVisibility", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getHorizontalVisibility", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_intValor] = new PropertyDescriptor ( "intValor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getIntValor", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_keymap] = new PropertyDescriptor ( "keymap", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getKeymap", "setKeymap" ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_margin] = new PropertyDescriptor ( "margin", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getMargin", "setMargin" ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_moeda] = new PropertyDescriptor ( "moeda", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, null, "setMoeda" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_navigationFilter] = new PropertyDescriptor ( "navigationFilter", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getNavigationFilter", "setNavigationFilter" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_numeroCasa] = new PropertyDescriptor ( "numeroCasa", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getNumeroCasa", "setNumeroCasa" ); // NOI18N
            properties[PROPERTY_numeroCasa].setPreferred ( true );
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredScrollableViewportSize] = new PropertyDescriptor ( "preferredScrollableViewportSize", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getPreferredScrollableViewportSize", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_scrollableTracksViewportHeight] = new PropertyDescriptor ( "scrollableTracksViewportHeight", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getScrollableTracksViewportHeight", null ); // NOI18N
            properties[PROPERTY_scrollableTracksViewportWidth] = new PropertyDescriptor ( "scrollableTracksViewportWidth", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getScrollableTracksViewportWidth", null ); // NOI18N
            properties[PROPERTY_scrollOffset] = new PropertyDescriptor ( "scrollOffset", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getScrollOffset", "setScrollOffset" ); // NOI18N
            properties[PROPERTY_selectedText] = new PropertyDescriptor ( "selectedText", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getSelectedText", null ); // NOI18N
            properties[PROPERTY_selectedTextColor] = new PropertyDescriptor ( "selectedTextColor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getSelectedTextColor", "setSelectedTextColor" ); // NOI18N
            properties[PROPERTY_selectionColor] = new PropertyDescriptor ( "selectionColor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getSelectionColor", "setSelectionColor" ); // NOI18N
            properties[PROPERTY_selectionEnd] = new PropertyDescriptor ( "selectionEnd", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getSelectionEnd", "setSelectionEnd" ); // NOI18N
            properties[PROPERTY_selectionStart] = new PropertyDescriptor ( "selectionStart", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getSelectionStart", "setSelectionStart" ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_text] = new PropertyDescriptor ( "text", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getText", "setText" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_valor] = new PropertyDescriptor ( "valor", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getValor", null ); // NOI18N
            properties[PROPERTY_value] = new PropertyDescriptor ( "value", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getValue", "setValue" ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_actionListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "actionListener", java.awt.event.ActionListener.class, new String[] {"actionPerformed"}, "addActionListener", "removeActionListener" ); // NOI18N
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_caretListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "caretListener", javax.swing.event.CaretListener.class, new String[] {"caretUpdate"}, "addCaretListener", "removeCaretListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_isMoeda81 = 81;
    ...
    private static final int METHOD_Valida165 = 165;
    private static final int METHOD_ValidaDiferenteZero166 = 166;
    private static final int METHOD_ValidaMaiorValor167 = 167;
    private static final int METHOD_ValidaMaiorZero168 = 168;
    private static final int METHOD_ValidaMenorValor169 = 169;
    private static final int METHOD_ValidaMenorZero170 = 170;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_isMoeda81] = new MethodDescriptor(com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class.getMethod("isMoeda", new Class[] {})); // NOI18N
            methods[METHOD_isMoeda81].setDisplayName ( "" );
            ...
            methods[METHOD_Valida165] = new MethodDescriptor(com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class.getMethod("Valida", new Class[] {})); // NOI18N
            methods[METHOD_Valida165].setDisplayName ( "" );
            methods[METHOD_ValidaDiferenteZero166] = new MethodDescriptor(com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class.getMethod("ValidaDiferenteZero", new Class[] {})); // NOI18N
            methods[METHOD_ValidaDiferenteZero166].setDisplayName ( "" );
            methods[METHOD_ValidaMaiorValor167] = new MethodDescriptor(com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class.getMethod("ValidaMaiorValor", new Class[] {java.math.BigDecimal.class})); // NOI18N
            methods[METHOD_ValidaMaiorValor167].setDisplayName ( "" );
            methods[METHOD_ValidaMaiorZero168] = new MethodDescriptor(com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class.getMethod("ValidaMaiorZero", new Class[] {})); // NOI18N
            methods[METHOD_ValidaMaiorZero168].setDisplayName ( "" );
            methods[METHOD_ValidaMenorValor169] = new MethodDescriptor(com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class.getMethod("ValidaMenorValor", new Class[] {java.math.BigDecimal.class})); // NOI18N
            methods[METHOD_ValidaMenorValor169].setDisplayName ( "" );
            methods[METHOD_ValidaMenorZero170] = new MethodDescriptor(com.hefesto.hefestocomponentes.HFNumberField.HFNumberField.class.getMethod("ValidaMenorZero", new Class[] {})); // NOI18N
            methods[METHOD_ValidaMenorZero170].setDisplayName ( "" );
